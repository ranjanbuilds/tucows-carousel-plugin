# Contributing to tucows-carousel-plugin

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/tucows/tucows-carousel-plugin) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork tucows-carousel-plugin, you can start by going to its [fork page](https://github.com/tucows/tucows-carousel-plugin/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/tucows-carousel-plugin
```
